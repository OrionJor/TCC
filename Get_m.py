...
def GetVertexData():
    dados = pd.read_excel('Dados/VRP_Spreadsheet_Solver_6P.xlsm',sheet_name="VRP Solver Console")
    ...
    #cria vetor estático
    dados2 = pd.read_excel('Dados/VRP_Spreadsheet_Solver_6P.xlsm',sheet_name="1. Locais")
    i = 0
...
def GetArcData():
    dados = pd.read_excel('Dados/VRP_Spreadsheet_Solver_6P.xlsm',sheet_name="2. Distâncias")
...
def GetInstanceData():
    ...
    Compat_vehicle = load_workbook(filename="Dados/VRP_Spreadsheet_Solver_6P.xlsm", read_only=True)   # open an Excel file and return a workbook
...
def GetVehicleTypeData():
    ...
    dados2 = pd.read_excel('Dados/VRP_Spreadsheet_Solver_6P.xlsm',sheet_name="3. Veículos")
    ...
    if instance.vehicle_location_incompatibility == True:
        dados3 = pd.read_excel('Dados/VRP_Spreadsheet_Solver_6P.xlsm',sheet_name="3.1. Compatibilidade do veículo")
